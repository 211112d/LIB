-- MainScript.lua
-- Loads all modules and adds features to KFC UI

-- Wait for UI to fully load
repeat task.wait() until library and library.flags

-- Load modules (adjust paths if using loadstring)
...
print("KFC Hook - All features loaded!")
